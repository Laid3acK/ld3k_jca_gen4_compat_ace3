...
class CfgAmmo
{
    // JCA Bullets inherited from vanilla class B_556x45_Ball. To avoid all conflict with other mods and RPT Updating base class, all JCA bullets with JCA as prefixe.
    ...
    // JCA Bullets inherited from vanilla class B_762x51_Ball. To avoid all conflict with other mods and RPT Updating base class, all JCA bullets with JCA as prefixe
...
class CfgWeapons
{
    ...
    class JCA_muzzle_snds_advanced_base: ItemCore
    {
        class ItemInfo: InventoryMuzzleItem_Base_F
        {
            ...
            class MagazineCoef
            {
                initSpeed=1; // ACE3, JCA 1.05, muzzle_snds_B/M 1.05
            };
            class MuzzleCoef
            {
                dispersionCoef=1; // ACE3 0.95, JCA 0.8, muzzle_snds_B/M 0.8
                recoilCoef=0.95;
                recoilProneCoef=0.95;
            };
        };
    };
    class JCA_muzzle_snds_tactical_base: ItemCore // muzzle_snds_B 7.62, muzzle_snds_M 5.56
    {
        class ItemInfo: InventoryMuzzleItem_Base_F
        {
    ...
    class JCA_muzzle_snds_SR25_base: ItemCore // muzzle_snds_B 7.62
    {
        class ItemInfo: InventoryMuzzleItem_Base_F
        {
            ...
            class AmmoCoef
            {
                visibleFire=0.3; // muzzle_snds_B, JCA 0.5 (muzzle_snds_570)
                audibleFire=0.04; // muzzle_snds_B, JCA 0.3 (muzzle_snds_570)
            };
            class MuzzleCoef
            {
